        ...
        <table>
            ...
            <?php
                ...
                foreach ($disciplinas as $disciplina) {
                    echo "<tr><td>" . ($disciplina[0]) . "</td>" .
                        "<td>" . ($disciplina[1]) . "</td>" .
                        "<td>" . ($disciplina[2]) . "</td>" .
                        "<td>" .
                        "<form action='' method='POST' style='display:inline;'>" .
                        "<input type='hidden' name='acao' value='editar'>" .
                        "<input type='hidden' name='id' value='" . ($disciplina[1]) . "'>" .
                        "<button type='submit' style='margin-right:12px;'>Editar</button>" .
                        "</form>" .
                        "<form action='' method='POST' style='display:inline;'>" .
            ...
            if (isset($_POST["acao"]) && $_POST["acao"] === 'editar') {
                ...
                if ($disciplinaParaEditar) {
                    echo "<form action='' method='POST'>" .
                        ...
                        "<div>" .
                        "<h3>Nome:</h3>" .
                        "<input type='text' name='nome' value='" . ($disciplinaParaEditar[0]) . "' required>" .
                        "</div>" .
                        "<div>" .
                        "<h3>Sigla:</h3>" .
                        "<input type='text' name='sigla' value='" . ($disciplinaParaEditar[1]) . "' required>" .
                        "</div>" .
                        "<div>" .
                        "<h3>Carga Horaria:</h3>" .
                        "<input type='number' name='carga' value='" . ($disciplinaParaEditar[2]) . "' required>" .
                        "</div>" .
